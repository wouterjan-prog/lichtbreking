...
export async function GET() {
  ...
  ['/', '/werk/', '/cursussen/', '/showreel/', '/over/', '/contact/', '/shotlist/', '/gereedschap/', '/gouden-uur/', '/dronespots/', '/curacao/', '/heerde/', '/faq/', '/zoeken/', '/start/', '/begrippen/', '/wat-is-nieuw/', '/artikelen/'].forEach((p) => add(p, p === '/' ? '1.0' : '0.7'));
