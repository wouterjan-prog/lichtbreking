...
export async function GET() {
  ...
  ['/', '/werk/', '/cursussen/', '/over/', '/contact/', '/shotlist/', '/gereedschap/', '/gouden-uur/', '/dronespots/', '/curacao/', '/heerde/', '/faq/', '/zoeken/', '/start/', '/begrippen/', '/privacy/', '/gids/pocket-4/', '/gids/action-6/', '/wat-is-nieuw/', '/artikelen/'].forEach((p) => add(p, p === '/' ? '1.0' : '0.7'));
