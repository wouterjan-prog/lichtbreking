...
export const proSettings = [
  ...
  },
  {
    ...
    rows: [
      ...
      { k: { nl: 'Kleurprofiel', en: 'Colour profile' }, v: { nl: 'Normal of D-Log M', en: 'Normal or D-Log M' }, why: { nl: 'Normal = meteen klaar. D-Log M geeft meer dynamiek voor lastig licht, maar je moet de beelden dan kleuren.', en: 'Normal = ready instantly. D-Log M gives more range for tricky light, but you must grade the footage.' } },
