...
export const t = {
  ...
  en: {
    ...
    cursussen: {
      ...
      c1: { kicker: 'Drone · DJI Mini 5 Pro', title: 'The Flight Filmer', meta: '14 modules · ~6 hrs', desc: 'Learn to film with your drone, not just fly it. From first power-on to a finished cinematic film — with shot recipes, decision trees and a field guide.' },
      c2: { kicker: 'Camera · DJI Osmo Pocket 4', title: 'The Ground Filmer', meta: '12 modules · field guide', desc: 'The eye-level imagery that completes your drone. Cinematic gimbal technique and how to merge air and ground into one film.' },
      c3: { kicker: 'Post · DaVinci + Final Cut', title: 'The Colour Filmer', meta: '8 modules · DaVinci + Final Cut', desc: 'From flat D-Log to a cinematic look. Workflow, scopes, developing D-Log, curves, matching shots and exporting — with the exact steps in both DaVinci Resolve and Final Cut Pro.' },
      c4: { kicker: 'Action & underwater · DJI Osmo Action 6', title: 'The Action Filmer', meta: '7 modules · action & underwater', desc: 'Master the Osmo Action 6: settings, the variable aperture, stabilisation, and bringing back colour underwater without a colour filter — using the underwater white balance and Dive mode.' },
    },
    showreel: {
