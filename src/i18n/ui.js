...
export const t = {
  nl: {
    ...
    home: {
      ...
      lead: 'Cinematische beelden uit de lucht en op ooghoogte — en gratis cursussen om het zelf te leren.',
  ...
  en: {
    ...
    home: {
      ...
      lead: 'Cinematic imagery from the air and at eye level — plus free courses to learn it yourself.',
